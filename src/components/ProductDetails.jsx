                    ...
                    <div className="row col-md-12">
                        ...
                        <div className="col-md-4">
                            ...
                            <div className="ms-4 col-md-12 mt-2">
                                ...
                                <div>
                                    <button style={{borderBottomRightRadius: "6px", borderBottomLeftRadius: "6px"}}
                                            onClick={() => addtocart(product?.id)}
                                            className="border-0 py-2 w-50 bg-purple text-white ">
                        ...
                        <div className="col-md-8">
                            <div className="">
                                <h1 className="display-6">Brand: <span className="text-info fw-bold">{product?.category?.title}</span></h1>
                                <h1 className="display-6">Model: <span className="text-success fw-bold">{product?.title}</span></h1>
                                <h2 className="display-6">Market Price: <span className="badge bg-warning text-dark"><del>{product?.market_price}$</del></span></h2>
                                <h2 className="display-6">Our Price: <span className="badge bg-success">{product?.selling_price}$</span></h2>
                            </div>
