    ...
    const add_product = async () => {
        ...
        await Axios({
            ...
            if (response.data.success) {
                ...
                formdata.append("productImageUrl", response?.data?.data?.display_url);
                        ...
                        <tbody>
                        {
                            only_product?.results?.map((item, i) => (
                                <tr key={i}>
                                    ...
                                    <td>
                                        <Link to={`/admin_action/add_product/product_details/${item.id}`}
                                              target="_blank" className="btn btn-info">Details</Link>
                                    </td>
                                    <td>
                ...
                <div className="col-md-4">
                    ...
                    <div>
                        ...
                        <div className="form-group my-3">
                            ...
                            <input onChange={e => setProduct_name(e.target.value)} type="text" className="form-control"
                                   placeholder="Write Product Names"/>
                        </div>

                        <div className="form-group my-3">
                            <label>Category</label>
                            <select onChange={e => setAll_category(e.target.value)} className="form-control"
                                    value={all_category}>
                        ...
                        <div className="form-group my-3">
                            ...
                            <input onChange={(e) => setMarket_price(e.target.value)} type="number"
                                   className="form-control" placeholder="Enter Market Price"/>
                        </div>

                        <div className="form-group my-3">
                            <label>Discount Price:</label>
                            <input onChange={(e) => setSell_price(e.target.value)} type="number"
                                   className="form-control" placeholder="Enter Discount Price"/>
                        </div>
